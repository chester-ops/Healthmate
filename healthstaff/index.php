...
checkRole($userRole, ['healthstaff']);
// Page header
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 d-flex align-items-center">
            ...
            <a href="<?php echo ROOT . "/includes/profile"; ?>" class="view-button"><span>View</span>
            </a>
        </div>
        <div class="col-md-4 d-flex align-items-center">
            <div class="card-record-title ">
            ...
            <a href="<?php echo ROOT . "/includes/logout"; ?>" class="view-button"><span>Leave</span>
            </a>
        </div>
        <div class="col-md-6">
            <div class="card">
